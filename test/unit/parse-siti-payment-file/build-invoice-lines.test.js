const { buildInvoiceLines, isInvoiceLineValid } = require('../../../app/parse-siti-payment-file/build-invoice-lines')
...
describe('Build invoice lines', () => {
  ...
  test('Falied validation of invoice lines for schemeCode', async () => {
  ...
  test('Falied validation of invoice lines for accountCode', async () => {
  ...
  test('Falied validation of invoice lines for fundCode', async () => {
  ...
  test('Falied validation of invoice lines for description', async () => {
