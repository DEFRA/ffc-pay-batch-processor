...
const SFI_SFIP_SEQUENCE_START = 7
const LUMP_SUMS_SFI23_SEQUENCE_START = 8
const DELINKED_CS_SEQUENCE_START = 6
const BPS_FC_CO_SEQUENCE_START = 5
const ES_SEQUENCE_START = 23
const IMPS_OFFSET = 1
const COHTC_SFI26_SEQUENCE_START = 9
...
const getSequence = (schemeId, filename) => {
  switch (schemeId) {
    ...
    case sfiPilot.schemeId:
      return Number(filename.substr(SFI_SFIP_SEQUENCE_START, SEQUENCE_LENGTH))
    case lumpSums.schemeId:
    case sfi23.schemeId:
      return Number(filename.substr(LUMP_SUMS_SFI23_SEQUENCE_START, SEQUENCE_LENGTH))
    case cs.schemeId:
    ...
    case combinedOffer.schemeId:
      return Number(filename.substr(BPS_FC_CO_SEQUENCE_START, SEQUENCE_LENGTH))
    case es.schemeId:
    ...
    case sfi26.schemeId:
      return Number(filename.substr(COHTC_SFI26_SEQUENCE_START, SEQUENCE_LENGTH))
    default:
